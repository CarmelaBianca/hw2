...
<html>
    <head>
        ...
        <script type="text/javascript">
            const CREA_ROUTE = "<?php echo e(url('crea')); ?>";
            const N_ADS ="<?php echo e(url('num_ads_crea')); ?>";
        </script>
    </head>
    <body>
...
</html><?php /**PATH C:\xampp\htdocs\example-app\resources\views/crea.blade.php ENDPATH**/ ?>